                                ...
                                <form method="POST" action="teste.php">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Raça</label>
                                                <input id="raca" name="raca" type="text" class="form-control" placeholder="Raça">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Usuário</label>
                                                <input id="username" name="username" type="text" class="form-control" placeholder="Nome de usuário" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Idade</label>
                                                <input id="age" name="age" type="text" class="form-control" placeholder="Idade do pet" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input id="first_name" name="first_name" type="text" class="form-control" placeholder="Primeiro nome" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Sobrenome</label>
                                                <input id="last_name" name="last_name" type="text" class="form-control" placeholder="Sobrenome do pet" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="endereco" name="endereco" type="text" class="form-control" placeholder="Endereço" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Cidade</label>
                                                <input id="city" name="city" type="text" class="form-control" placeholder="Cidade" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>País</label>
                                                <input id="country" name="country" type="text" class="form-control" placeholder="País" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Código Postal</label>
                                                <input id="postal_code" name="postal_code" type="number" class="form-control" placeholder="CEP">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="about_me" name="about_me" textarea rows="5" class="form-control" placeholder="Escreva aqui uma descrição sobre o animal doméstico." value=""></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <label class="avatar border-gray" for="picture__input" tabIndex="0">
                                     ...
                                     -->
                                      <h4 class="title">Nome do Pet<br />
                                         <small>Raça, Idade</small>
                                      </h4>
                                    </a>
                                </div>
